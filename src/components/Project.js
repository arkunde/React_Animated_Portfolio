...
const Project = () => {
  return (
    ...
    <div className="container projects my-3" id="project">
      <h1>PROJECTS</h1>
      <div className="row d-flex justify-content-center align-item-center" style={{paddingLeft: "220px"}}>
        {project.map((data)=>(
          <>
          <div key={data.id}
           className="my-4 col-md-6 col-sm-6">
          <div className="card bg-dark text-light"
           style={{width:"18rem",  border: "2px solid yellow" , boxShadow: "5px 5px 10px 0px rgba(101,175,10,0.5)"}}
             data-aos="flip-right"
